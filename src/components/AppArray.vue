...
import type { Props, Task } from '@/typing'
import { ref, defineProps } from 'vue'

const props = defineProps<{
  valueArray: Array<Task>
}>()

// const emit = defineEmits(['response'])
// const nouvelleTache= ref("")
// function addList(){
//     emit("response", arrayTodo);
//     nouvelleTache.value = "";
// }

console.log('arrayvalue', props.valueArray)
...
<template>
  <div class="table">
    <table>
      ...
      <!-- <tbody v-else> -->
      <tbody>
        <tr v-for="todo in valueArray" :key="todo.id">
          <td>
